...
#prompt = ["Heat the oil in a kadhai over medium-high heat"]
prompt = preprocessedresponse("How to make Gulab Jamun Recipe?")
# prompt = ["AI/ML in Education"]
...
grid = grid_image_generator(imageslist)
delay_seconds = 2
